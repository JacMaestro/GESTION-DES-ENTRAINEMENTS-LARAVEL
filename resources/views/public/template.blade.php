    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: left;">
			            <h1><a href="#">YoyoAutoTrading</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
	      ...
	      <tr>
	      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
	      		<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					    <th width="80%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Identifiants</th> 
					  </tr>
					  <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  ...
					  <tr>
					  	<td valign="middle" style="text-align:left; padding: 1em 2.5em;">
					  		<p><a href="{LINK}" class="btn btn-primary">Connectez-vous !</a></p>
					  	</td>
					  </tr>
	      	</table>
	      </tr><!-- end tr -->
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="middle" class="bg_light footer email-section">
            <table>
            	<tr>
                <td valign="top" width="50.333%" style="padding-top: 5px;">
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      Copyright &copy; 2022 YoyoAutoTrading  
                      </td>
                    </tr>
                  </table>
                </td> 
